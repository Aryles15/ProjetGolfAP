...
//AJOUTER JUSTE UN PAKAGE CONFIGURATION LE RESTE LIBRE
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/", "/categorie").permitAll()//on autorise l uri /home a tout le monde .permitAll()==permis a tous
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication()
                ...
                .authorities("EDITEUR","GESTIONNAIRE","USER","ADMIN","HABILITATION_ADMIN")
